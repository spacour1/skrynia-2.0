...
export default {
  ...
  orderEvents: {
    ...
    refunded: { title: "Замовлення повернено", body: "Кошти з escrow повернено покупцеві." },
  ...
  email: {
    ...
    emailChangeConfirm: {
      subject: "Підтвердьте новий email на SKRYNIA",
      title: "Підтвердьте новий email",
      body: "Для вашого акаунта SKRYNIA запитано зміну email. Поточна адреса залишатиметься активною, доки ви не підтвердите нову. Посилання діє 24 години.",
      cta: "Підтвердити новий email",
      footer: "Якщо ви не запитували цю зміну, не переходьте за посиланням і зверніться до підтримки.",
      text: "Підтвердьте новий email за посиланням: {link}"
    },
    emailChangeAlert: {
      subject: "Запитано зміну email на SKRYNIA",
      title: "Запитано зміну email",
      body: "Хтось запросив нову адресу email для вашого акаунта SKRYNIA. Поточний email поки активний. Якщо це були не ви, негайно захистіть акаунт.",
      cta: "Перевірити безпеку",
      footer: "Email не зміниться, доки нову адресу не буде підтверджено.",
      text: "Для вашого акаунта SKRYNIA запитано зміну email. Якщо це були не ви, негайно перевірте безпеку акаунта. Поточний email залишається активним."
    }
  },
  telegram: {
