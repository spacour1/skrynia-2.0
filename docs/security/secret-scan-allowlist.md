...
Gitleaks scans the complete Git history with its default rules. The repository adds only three
finding-fingerprint exceptions covering two strings that were manually verified as
documentation placeholders on 2026-07-24.
...
| `docs/security/secret-scan-allowlist.md` | Literal quotation of the first-row placeholder | `generic-api-key` | The allowlist documentation repeated the same invalid instructional value in a later commit. |
