...
export default {
  ...
  orderEvents: {
    ...
    refunded: { title: "Заказ возвращен", body: "Средства из escrow возвращены покупателю." },
  ...
  email: {
    ...
    emailChangeConfirm: {
      subject: "Подтвердите новый email на SKRYNIA",
      title: "Подтвердите новый email",
      body: "Для вашего аккаунта SKRYNIA запрошена смена email. Текущий адрес останется активным, пока вы не подтвердите новый. Ссылка действует 24 часа.",
      cta: "Подтвердить новый email",
      footer: "Если вы не запрашивали это изменение, не переходите по ссылке и обратитесь в поддержку.",
      text: "Подтвердите новый email по ссылке: {link}"
    },
    emailChangeAlert: {
      subject: "Запрошена смена email на SKRYNIA",
      title: "Запрошена смена email",
      body: "Кто-то запросил новый адрес email для вашего аккаунта SKRYNIA. Текущий email пока активен. Если это были не вы, немедленно защитите аккаунт.",
      cta: "Проверить безопасность",
      footer: "Email не изменится, пока новый адрес не будет подтверждён.",
      text: "Для вашего аккаунта SKRYNIA запрошена смена email. Если это были не вы, немедленно проверьте безопасность аккаунта. Текущий email остаётся активным."
    }
  },
  telegram: {
