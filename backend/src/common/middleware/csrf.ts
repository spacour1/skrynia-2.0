...
// auth bootstrap endpoints (no session cookie yet) and the LiqPay/Monobank server-to-server
// webhooks (external POSTs that never carry our cookies in the first place).
