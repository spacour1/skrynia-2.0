...
const colors: Record<string, string> = {
  ...
  canceled: "bg-zinc-100 text-zinc-700 dark:bg-zinc-400/15 dark:text-zinc-200",
  ...
  in_review: "bg-amber-100 text-amber-800 dark:bg-amber-400/15 dark:text-amber-200",
  resolving: "bg-amber-100 text-amber-800 dark:bg-amber-400/15 dark:text-amber-200",
  resolved: "bg-emerald-100 text-emerald-800 dark:bg-emerald-400/15 dark:text-emerald-200",
  resolution_failed: "bg-rose-100 text-rose-800 dark:bg-rose-400/15 dark:text-rose-200",
