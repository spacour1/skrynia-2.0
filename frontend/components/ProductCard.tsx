...
export function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <article className="interactive-card group relative overflow-hidden">
      ...
      <div className="mt-5 flex items-end justify-between gap-3 border-t border-line px-4 pb-4 pt-3">
        <Link href={`/sellers/${product.sellerId}`} className="relative z-20 inline-flex min-w-0 items-center gap-1.5 text-sm font-medium text-brand hover:underline">
